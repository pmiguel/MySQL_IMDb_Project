...
2) Create IMDb data base in MySQL:
 mysql> SOURCE /db_files/imdb-create-tables.sql

3) Load data using this script in MySQL:
 mysql> SOURCE /db_files/imdb-load-data.sql

4) Add constraints to the IMDb database in MySQL
 mysql> SOURCE /db_files/imdb-add-constraints.sql

 5) Add indexes to the IMDb database in MySQL
 mysql> SOURCE /db_files/imdb-index-tables.sql
